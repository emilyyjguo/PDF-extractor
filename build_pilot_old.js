...
children.push(exLine('例 4-1）  ', ''));
children.push(imgPara('p4_ex1_problem', 400, AlignmentType.LEFT));  // Math formula as image
children.push(body('解：根据罗必塔法则，我们有：'), gap(60));
children.push(imgPara('p4_ex1_solution', 520));  // Solution formula only, no text
children.push(gap());

children.push(exLine('例 4-2）  ', ''));
children.push(imgPara('p4_ex2_problem', 400, AlignmentType.LEFT));  // Math formula as image
...
children.push(exLine('例 4-3）  ', ''));
children.push(imgPara('p4_ex3_problem', 400, AlignmentType.LEFT));  // Math formula as image
